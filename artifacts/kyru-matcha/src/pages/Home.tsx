    ...
    <section id="hero">
      <div className="relative h-[100dvh] flex flex-col justify-between overflow-hidden bg-white text-[#181916]">
        ...
        <div aria-hidden="true"
          className="hero-letter select-none pointer-events-none font-sans font-medium lowercase tracking-[-0.05em] leading-[0.72] text-[48vw] -mt-[11vw] md:-mt-[8vw] -ml-[1.5vw]">
          kyru
        </div>
    ...
    <div className="bg-white text-[#181916] overflow-x-hidden pt-[72px]">
      ...
      <style dangerouslySetInnerHTML={{ __html: `
        ...
        @media (min-width: 768px) {
          .hero-letter { font-size: min(35vw, 45vh); }
        }
      `}} />
    </div>
  );
